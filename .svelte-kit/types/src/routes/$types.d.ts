...
type LayoutRouteId = RouteId | "/" | "/explore" | "/history" | "/library" | "/manga/[sourceId]/[mangaId]" | "/manga/[sourceId]/[mangaId]/[chapterId]" | "/profile" | "/search" | "/settings" | "/sources" | "/updates" | null
type LayoutParams = RouteParams & { sourceId?: string | undefined; mangaId?: string | undefined; chapterId?: string | undefined }
